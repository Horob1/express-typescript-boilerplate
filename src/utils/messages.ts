export default {
  ...
  USER: {
    ...
    EMAIL_OR_USERNAME_IS_NOT_TAKEN: 'Email or username is not taken',
    EMAIL_IS_NOT_TAKEN: 'Email is not taken',
    USERNAME_IS_NOT_TAKEN: 'Username is not taken',
    USER_REGISTER_SUCCESSFULLY: 'Register successfully',
    SEND_VERIFICATION_EMAIL: 'Mail verification OTP sent successfully',
    SEND_RESET_PASSWORD_EMAIL: 'Reset password OTP sent successfully',
    ...
    LOGOUT_ALL_SUCCESSFULLY: 'Logout all successfully',
    FORGOT_PASSWORD_EMAIL_TITLE: 'Reset Password OTP',
    RESET_PASSWORD_SUCCESSFULLY: 'Reset password successfully',
    VERIFICATION_EMAIL_TITLE: 'Email Verification OTP',
    ...
    GET_DEVICE_LIST_SUCCESSFULLY: 'Get device list successfully',
  },
  OTP: {
